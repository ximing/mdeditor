...
var _temp = function () {
    ...
    __REACT_HOT_LOADER__.register(ONEDAY, 'ONEDAY', 'src/lib/timeRelated.js');

    __REACT_HOT_LOADER__.register(formatMessageDate, 'formatMessageDate', 'src/lib/timeRelated.js');

    __REACT_HOT_LOADER__.register(formatDate, 'formatDate', 'src/lib/timeRelated.js');

    __REACT_HOT_LOADER__.register(weekArray, 'weekArray', 'src/lib/timeRelated.js');

    __REACT_HOT_LOADER__.register(getWeekDay, 'getWeekDay', 'src/lib/timeRelated.js');

    __REACT_HOT_LOADER__.register(getZeroTime, 'getZeroTime', 'src/lib/timeRelated.js');

    __REACT_HOT_LOADER__.register(compareDateTime, 'compareDateTime', 'src/lib/timeRelated.js');

    __REACT_HOT_LOADER__.register(getTimeByString, 'getTimeByString', 'src/lib/timeRelated.js');

    __REACT_HOT_LOADER__.register(getWeekDay2, 'getWeekDay2', 'src/lib/timeRelated.js');

    __REACT_HOT_LOADER__.register(isToday, 'isToday', 'src/lib/timeRelated.js');
}();
