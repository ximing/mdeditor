...
var HotKeysDialog = function (_Component) {
    ...
    function HotKeysDialog() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = HotKeysDialog.__proto__ || Object.getPrototypeOf(HotKeysDialog)).call.apply(_ref, [this].concat(args))), _this), _this.closeDialog = function () {
            ...
            return (_this2 = _this).__closeDialog__REACT_HOT_LOADER__.apply(_this2, arguments);
        }, _temp), _possibleConstructorReturn(_this, _ret);
    }

    _createClass(HotKeysDialog, [{
        key: '__closeDialog__REACT_HOT_LOADER__',
        value: function __closeDialog__REACT_HOT_LOADER__() {
            return this.__closeDialog__REACT_HOT_LOADER__.apply(this, arguments);
        }
    }, {
        key: '__closeDialog__REACT_HOT_LOADER__',
        value: function __closeDialog__REACT_HOT_LOADER__() {
...
var _temp2 = function () {
    ...
    __REACT_HOT_LOADER__.register(HotKeysDialog, 'HotKeysDialog', 'src/components/hotKeysDialog/hotKeysDialog.js');
}();
