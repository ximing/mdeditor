...
var _temp = function () {
    ...
    __REACT_HOT_LOADER__.register(sizeConvert, 'sizeConvert', 'src/components/list/item.js');

    __REACT_HOT_LOADER__.register(_default, 'default', 'src/components/list/item.js');
}();
