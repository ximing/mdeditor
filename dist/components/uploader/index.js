...
var _temp = function () {
    ...
    __REACT_HOT_LOADER__.register(_config, '_config', 'src/components/uploader/index.js');

    __REACT_HOT_LOADER__.register(Uploader, 'Uploader', 'src/components/uploader/index.js');

    __REACT_HOT_LOADER__.register(UploaderStatus, 'UploaderStatus', 'src/components/uploader/index.js');

    __REACT_HOT_LOADER__.register(FileStatus, 'FileStatus', 'src/components/uploader/index.js');
}();
