...
var _temp = function () {
    ...
    __REACT_HOT_LOADER__.register(indexOfListener, 'indexOfListener', 'src/components/uploader/eventBus.js');

    __REACT_HOT_LOADER__.register(alias, 'alias', 'src/components/uploader/eventBus.js');

    __REACT_HOT_LOADER__.register(EventEmitter, 'EventEmitter', 'src/components/uploader/eventBus.js');
}();
