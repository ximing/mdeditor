...
var CommonEditor = (_dec = inject('catalogue'), _dec(_class = observer(_class = function (_Component) {
    ...
    function CommonEditor() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = CommonEditor.__proto__ || Object.getPrototypeOf(CommonEditor)).call.apply(_ref, [this].concat(args))), _this), _this.closeCatalogue = function () {
            ...
            return (_this2 = _this).__closeCatalogue__REACT_HOT_LOADER__.apply(_this2, arguments);
        }, _temp), _possibleConstructorReturn(_this, _ret);
    }

    _createClass(CommonEditor, [{
        key: '__closeCatalogue__REACT_HOT_LOADER__',
        value: function __closeCatalogue__REACT_HOT_LOADER__() {
            return this.__closeCatalogue__REACT_HOT_LOADER__.apply(this, arguments);
        }
    }, {
        key: '__closeCatalogue__REACT_HOT_LOADER__',
        value: function __closeCatalogue__REACT_HOT_LOADER__() {
...
var _temp2 = function () {
    ...
    __REACT_HOT_LOADER__.register(CommonEditor, 'CommonEditor', 'src/catalogue.js');
}();
